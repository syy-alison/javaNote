...
<img src="assets/image-20240612111602797.png" alt="image-20240612111602797" style="zoom:20%;" />

网络接口层的传输单位是帧（frame），IP 层的传输单位是包（packet），TCP 层的传输单位是段（segment），HTTP 的传输单位则是消息或报文（message）。但这些名词并没有什么本质的区分，可以统称为数据包。

<img src="assets/image-20240612111644916.png" alt="image-20240612111644916" style="zoom:25%;" />
...
>
> <img src="assets/image-20240612110317287.png" alt="image-20240612110317287" style="zoom: 33%;" />
>
...
>
> <img src="assets/image-20240612110846982.png" alt="image-20240612110846982" style="zoom:25%;" />
...
<img src="assets/image-20240612163120789.png" alt="image-20240612163120789" style="zoom:33%;" />
...
<img src="assets/image-20240612165248993.png" alt="image-20240612165248993" style="zoom:20%;" />
...
- 客户端发送带有SYN标志的数据包，同时含有客户端生成的随机初始化序号。
  ...
  >
  > <img src="assets/image-20240612165348572.png" alt="image-20240612165348572" style="zoom:20%;" />
...
- 服务端发送带有SYN=1，ACK=1 标志的数据包。
  ...
  >
  > <img src="/assets/image-20240612165509314.png" alt="image-20240612165509314" style="zoom:20%;" />
...
- 客户端发送带有ACK=1标志的数据包
  ...
  >
  > <img src="assets/image-20240612165554090.png" alt="image-20240612165554090" style="zoom:20%;" />
...
<img src="assets/image-20240612203842440.png" alt="image-20240612203842440" style="zoom:30%;" />
...
<img src="assets/image-20240612183908159.png" alt="image-20240612183908159" style="zoom:50%;" />
...
<img src="assets/image-20240612181209256.png" alt="image-20240612181209256" style="zoom:25%;" />
...
<img src="assets/image-20240612184056173.png" alt="image-20240612184056173" style="zoom:30%;" />
...
<img src="assets/image-20240612184959143.png" alt="image-20240612184959143" style="zoom:33%;" />
...
<img src="assets/image-20240613143930378.png" alt="image-20240613143930378" style="zoom:20%;" />
...
<img src="assets/image-20240613144244561.png" alt="image-20240613144244561" style="zoom:30%;" />
...
<img src="assets/image-20240613144418355.png" alt="image-20240613144418355" style="zoom:30%;" />
...
<img src="assets/image-20240613144731605.png" alt="image-20240613144731605" style="zoom:30%;" />
...
<img src="assets/image-20240613145430059.png" alt="image-20240613145430059" style="zoom:33%;" />
...
<img src="assets/image-20240612165012721.png" alt="image-20240612165012721" style="zoom: 25%;" />
...
> - 确认应答丢失
>
> <img src="assets/image-20240612192153237.png" alt="image-20240612192153237" style="zoom:30%;" />
>
> **超时时间应该设置为多少呢？**
>
...
> 2. **快速重传**
>
> <img src="assets/image-20240613150521320.png" alt="image-20240613150521320" style="zoom:40%;" />
>
...
- 拥塞控制的四种算法
  ...
  <img src="assets/image-20240613160439654.png" alt="image-20240613160439654" style="zoom:30%;" />
...
<img src="assets/image-20240613160749847.png" alt="image-20240613160749847" style="zoom:30%;" />
...
<img src="assets/image-20240612143205000.png" alt="image-20240612143205000" style="zoom: 33%;" />
...
<img src="assets/image-20240612143650298.png" alt="image-20240612143650298" style="zoom:33%;" />



<img src="assets/image-20240612143713247.png" alt="image-20240612143713247" style="zoom:33%;" />
...
<img src="assets/image-20240612143829495.png" alt="image-20240612143829495" style="zoom: 33%;" />
...
<img src="./assets/image-20240612150249819.png" alt="image-20240612150249819" style="zoom:25%;" />
...
> [!NOTE]
>
> <img src="assets/image-20240612150437356.png" alt="image-20240612150437356" style="zoom:25%;" />
>
...
>
> <img src="assets/image-20240612150537216.png" alt="image-20240612150537216" style="zoom:25%;" />
...
<img src="assets/image-20240612151157881.png" alt="image-20240612151157881" style="zoom:25%;" />
...
>
> <img src="assets/image-20240612161458673.png" alt="image-20240612161458673" style="zoom:33%;" />
>
> <img src="assets/image-20240612161702523.png" alt="image-20240612161702523" style="zoom:33%;" />
>
...
<img src="assets/image-20240612162102497.png" alt="image-20240612162102497" style="zoom:50%;" />
...
- 无队头阻塞
  ...
  <img src="assets/image-20240612161935824.png" alt="image-20240612161935824" style="zoom:33%;" />
...
- 更快的连接建立
  ...
  <img src="assets/image-20240612162311738.png" alt="image-20240612162311738" style="zoom:40%;" />

  甚至，在第二次连接的时候，应用数据包可以和 QUIC 握手信息（连接信息 + TLS 信息）一起发送，达到 0-RTT 的效果。

  如下图右边部分，HTTP/3 当会话恢复时，有效负载数据与第一个数据包一起发送，可以做到 0-RTT（下图的右下角）：

  <img src="assets/image-20240612162412421.png" alt="image-20240612162412421" style="zoom:40%;" />
...
<img src="assets/image-20240612153130992.png" alt="image-20240612153130992" style="zoom:40%;" />
...
<img src="assets/image-20240612154749555.png" alt="image-20240612154749555" style="zoom:40%;" />

但事实上，证书的验证过程中**还存在一个证书信任链的问题**，因为我们向 CA 申请的证书一般不是根证书签发的，而是由中间证书签发的，比如百度的证书，从下图你可以看到，证书的层级有三级：

<img src="assets/image-20240612154943750.png" alt="image-20240612154943750" style="zoom:50%;" />
...
<img src="assets/image-20240612160133550.png" alt="image-20240612160133550" style="zoom:40%;" />
...
<img src="assets/image-20240612160405896.png" alt="image-20240612160405896" style="zoom:50%;" />
...
<img src="assets/image-20240612161101010.png" alt="image-20240612161101010" style="zoom:33%;" />
...
<img src="assets/image-20240613162416995.png" alt="image-20240613162416995" style="zoom:50%;" />
