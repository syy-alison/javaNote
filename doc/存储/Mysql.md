...
![image-20240723141710496](assets/image-20240723141710496.png)
...
![image-20240622215318215](assets/image-20240622215318215.png)
...
- **更新语句执行流程**如下：分析器----》权限校验----》执行器---》引擎---redo log(prepare 状态)---》binlog**（归档日志）**---》redo log(commit状态)
...
![image-20240630143353730](assets/image-20240630143353730.png)
...
![image-20240730141533757](assets/image-20240730141533757.png)
